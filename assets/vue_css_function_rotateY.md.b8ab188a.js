import{_ as D,o as n,c as t,O as F,Q as y,z as s,D as i,G as a,B as e,R as C,a as l}from"./chunks/framework.318fa179.js";const d={},c=o=>(F("data-v-7bcbc2ec"),o=o(),y(),o),A={class:"base"},_=c(()=>s("div",{class:"normal rotated"},"Rotated",-1)),h=c(()=>s("div",{class:"normal"},"Not rotated",-1)),m=[_,h];function u(o,r){return n(),t("div",A,m)}const v=D(d,[["render",u],["__scopeId","data-v-7bcbc2ec"]]),f=C('<h1 id="rotatey" tabindex="-1">rotateY() <a class="header-anchor" href="#rotatey" aria-label="Permalink to &quot;rotateY()&quot;">​</a></h1><h2 id="描述" tabindex="-1">描述 <a class="header-anchor" href="#描述" aria-label="Permalink to &quot;描述&quot;">​</a></h2><p>rotateY() CSS 函数将元素绕 Y 轴旋转给定角度。</p><h2 id="语法" tabindex="-1">语法 <a class="header-anchor" href="#语法" aria-label="Permalink to &quot;语法&quot;">​</a></h2><div class="language-css"><button title="Copy Code" class="copy"></button><span class="lang">css</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">transform: rotateY(&lt;angle</span><span style="color:#89DDFF;">&gt;</span><span style="color:#A6ACCD;">);</span></span></code></pre></div><h2 id="值" tabindex="-1">值 <a class="header-anchor" href="#值" aria-label="Permalink to &quot;值&quot;">​</a></h2><ul><li>angle 正值使元素顺时针旋转，负值使元素逆时针旋转。</li></ul><h2 id="效果展示" tabindex="-1">效果展示 <a class="header-anchor" href="#效果展示" aria-label="Permalink to &quot;效果展示&quot;">​</a></h2>',8),b=s("div",{class:"language-vue vp-adaptive-theme"},[s("span",{class:"lang"},"vue"),s("pre",{"v-pre":"",class:"shiki material-theme-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#89DDFF"}},"<"),s("span",{style:{color:"#F07178"}},"template"),s("span",{style:{color:"#89DDFF"}},">")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#89DDFF"}},"</"),s("span",{style:{color:"#F07178"}},"style"),s("span",{style:{color:"#89DDFF"}},">")])])])],-1),Y=JSON.parse('{"title":"rotateY()","description":"","frontmatter":{"layout":"doc"},"headers":[],"relativePath":"vue/css/function/rotateY.md","filePath":"vue/css/function/rotateY.md","lastUpdated":1691713347000}'),g={name:"vue/css/function/rotateY.md"},k=Object.assign(g,{setup(o){return(r,x)=>{const p=i("demo");return n(),t("div",null,[f,a(p,{customClass:"",sourceCode:`<template>
  <div class="base">
...
`},{highlight:e(()=>[b]),default:e(()=>[a(v)]),_:1})])}}});export{Y as __pageData,k as default};
