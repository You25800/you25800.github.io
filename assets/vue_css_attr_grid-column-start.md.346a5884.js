import{_ as D,o as e,c as t,R as o,D as F,G as n,B as a,z as s,a as l}from"./chunks/framework.318fa179.js";const y={},i={class:"base"},C=o('<div class="grid-container" data-v-94949012><div class="item-a" data-v-94949012>A</div><div data-v-94949012>B</div><div data-v-94949012>C</div><div data-v-94949012>D</div><div data-v-94949012>E</div><div data-v-94949012>F</div></div><div class="grid-container2" data-v-94949012><div data-v-94949012>A</div><div class="item-b" data-v-94949012>B</div><div data-v-94949012>C</div><div data-v-94949012>D</div><div data-v-94949012>E</div><div data-v-94949012>F</div></div>',2),d=[C];function A(c,r){return e(),t("div",i,d)}const v=D(y,[["render",A],["__scopeId","data-v-94949012"]]),_=o('<h1 id="grid-column-start" tabindex="-1">grid-column-start <a class="header-anchor" href="#grid-column-start" aria-label="Permalink to &quot;grid-column-start&quot;">​</a></h1><h2 id="描述" tabindex="-1">描述 <a class="header-anchor" href="#描述" aria-label="Permalink to &quot;描述&quot;">​</a></h2><p>该 grid-column-start 属性确定元素在网格布局中的位置来自哪一列，或者元素将跨越多少列。为了确定元素将占用多少列，或者元素将在列的哪一行结束，可以使用 grid-column-end 属性。</p><h2 id="效果展示" tabindex="-1">效果展示 <a class="header-anchor" href="#效果展示" aria-label="Permalink to &quot;效果展示&quot;">​</a></h2>',4),m=s("div",{class:"language-vue vp-adaptive-theme"},[s("span",{class:"lang"},"vue"),s("pre",{"v-pre":"",class:"shiki material-theme-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#89DDFF"}},"<"),s("span",{style:{color:"#F07178"}},"template"),s("span",{style:{color:"#89DDFF"}},">")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"    "),s("span",{style:{color:"#B2CCD6"}},"grid-template-columns"),s("span",{style:{color:"#89DDFF"}},":"),s("span",{style:{color:"#A6ACCD"}}," [line1] "),s("span",{style:{color:"#F78C6C"}},"25%"),s("span",{style:{color:"#A6ACCD"}}," [line2] "),s("span",{style:{color:"#F78C6C"}},"25%"),s("span",{style:{color:"#A6ACCD"}}," [line3] "),s("span",{style:{color:"#F78C6C"}},"25%"),s("span",{style:{color:"#A6ACCD"}}," [line4] "),s("span",{style:{color:"#F78C6C"}},"25%"),s("span",{style:{color:"#89DDFF"}},";")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"    "),s("span",{style:{color:"#B2CCD6"}},"grid-column-start"),s("span",{style:{color:"#89DDFF"}},":"),s("span",{style:{color:"#A6ACCD"}}," line4"),s("span",{style:{color:"#89DDFF"}},";")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#89DDFF"}},"</"),s("span",{style:{color:"#F07178"}},"style"),s("span",{style:{color:"#89DDFF"}},">")])])])],-1),g=o('<h2 id="语法" tabindex="-1">语法 <a class="header-anchor" href="#语法" aria-label="Permalink to &quot;语法&quot;">​</a></h2><div class="language-css"><button title="Copy Code" class="copy"></button><span class="lang">css</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#FFCB6B;">grid-column-start</span><span style="color:#A6ACCD;">: auto </span><span style="color:#89DDFF;">|</span><span style="color:#A6ACCD;"> </span><span style="color:#FFCB6B;">line</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">|</span><span style="color:#A6ACCD;"> </span><span style="color:#FFCB6B;">line-name</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">|</span><span style="color:#A6ACCD;"> </span><span style="color:#FFCB6B;">span</span><span style="color:#A6ACCD;"> line;</span></span></code></pre></div><h2 id="值" tabindex="-1">值 <a class="header-anchor" href="#值" aria-label="Permalink to &quot;值&quot;">​</a></h2><ul><li>auto 一个关键字，指示属性不会影响元素在网格布局中的位置（自动放置、自动范围或默认范围 1）。这是默认值。</li><li>line 一个整数，对应于网格布局中元素的初始面（从元素的左边缘从左到右计算面，示意图显示在页面顶部）。如果指定了负整数，则计数的顺序相反，从显式布局网格的末端边缘开始。值 0 无效</li><li>line-name 引用网格布局中的命名列的字符串值。元素位于指定元素的初始面。</li><li>span line 带有整数的 span 关键字，用于确定网格元素将跨越多少列。如果省略整数，则默认值为 1。负值或值 0 无效。</li></ul>',4),b=JSON.parse('{"title":"grid-column-start","description":"","frontmatter":{"layout":"doc"},"headers":[],"relativePath":"vue/css/attr/grid-column-start.md","filePath":"vue/css/attr/grid-column-start.md","lastUpdated":1690962385000}'),u={name:"vue/css/attr/grid-column-start.md"},E=Object.assign(u,{setup(c){return(r,B)=>{const p=F("demo");return e(),t("div",null,[_,n(p,{customClass:"",sourceCode:`<template>
  <div class="base">
...
`},{highlight:a(()=>[m]),default:a(()=>[n(v)]),_:1}),g])}}});export{b as __pageData,E as default};
