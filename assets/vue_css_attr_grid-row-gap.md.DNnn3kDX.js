import{_ as p,c as k,o as e,j as i,B as D,b3 as h,G as n,w as t,a as s}from"./chunks/framework.CatkIGlB.js";const g={},A={class:"base"};function B(r,l){return e(),k("div",A,[...l[0]||(l[0]=[i("div",{class:"grid-container"},[i("div",null,"A"),i("div",null,"B"),i("div",null,"C")],-1),i("div",{class:"grid-container2"},[i("div",null,"A"),i("div",null,"B"),i("div",null,"C")],-1)])])}const F=p(g,[["render",B],["__scopeId","data-v-79804e7c"]]),o=JSON.parse('{"title":"grid-row-gap","description":"","frontmatter":{"layout":"doc"},"headers":[],"relativePath":"vue/css/attr/grid-row-gap.md","filePath":"vue/css/attr/grid-row-gap.md","lastUpdated":1690962385000}'),y={name:"vue/css/attr/grid-row-gap.md"},E=Object.assign(y,{setup(r){return(l,a)=>{const d=D("demo");return e(),k("div",null,[a[1]||(a[1]=h('<h1 id="grid-row-gap" tabindex="-1">grid-row-gap <a class="header-anchor" href="#grid-row-gap" aria-label="Permalink to &quot;grid-row-gap&quot;">​</a></h1><h2 id="描述" tabindex="-1">描述 <a class="header-anchor" href="#描述" aria-label="Permalink to &quot;描述&quot;">​</a></h2><p>grid-row-gap 属性确定网格布局中线条之间的距离（间隙）。</p><div class="warning custom-block"><p class="custom-block-title">注意</p><p>CSS 网格布局模块最初将该属性定义为 grid-row-gap ，后来被 row-gap 属性替换。但是，为了支持更广泛的实现 grid-row-gap 属性而不是 row-gap 的浏览器，您应该使用 grid-row-gap 属性。</p></div><h2 id="效果展示" tabindex="-1">效果展示 <a class="header-anchor" href="#效果展示" aria-label="Permalink to &quot;效果展示&quot;">​</a></h2>',5)),n(d,{customClass:"",sourceCode:`<template>
  <div class="base">
...
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#90A4AE","--shiki-dark":"#BABED8"}},"  }")]),s(`
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#90A4AE","--shiki-dark":"#BABED8"}},"  .grid-container {")]),s(`
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#90A4AE","--shiki-dark":"#BABED8"}},"    grid-row-gap: 10px;")]),s(`
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#90A4AE","--shiki-dark":"#BABED8"}},"  }")]),s(`
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#90A4AE","--shiki-dark":"#BABED8"}},"  .grid-container2 {")]),s(`
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#90A4AE","--shiki-dark":"#BABED8"}},"    height: 50%;")]),s(`
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#90A4AE","--shiki-dark":"#BABED8"}},"    grid-row-gap: 20%;")]),s(`
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#90A4AE","--shiki-dark":"#BABED8"}},"  }")]),s(`
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#90A4AE","--shiki-dark":"#BABED8"}},"}")]),s(`
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#39ADB5","--shiki-dark":"#89DDFF"}},"</"),i("span",{style:{"--shiki-light":"#E53935","--shiki-dark":"#F07178"}},"style"),i("span",{style:{"--shiki-light":"#39ADB5","--shiki-dark":"#89DDFF"}},">")])])])],-1)])]),default:t(()=>[n(F)]),_:1}),a[2]||(a[2]=h(`<h2 id="语法" tabindex="-1">语法 <a class="header-anchor" href="#语法" aria-label="Permalink to &quot;语法&quot;">​</a></h2><div class="language-css vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">css</span><pre class="shiki shiki-themes material-theme-lighter material-theme-palenight vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#E2931D;--shiki-dark:#FFCB6B;">grid-row-gap</span><span style="--shiki-light:#90A4AE;--shiki-dark:#BABED8;">: normal </span><span style="--shiki-light:#39ADB5;--shiki-dark:#89DDFF;">|</span><span style="--shiki-light:#90A4AE;--shiki-dark:#BABED8;"> &lt;</span><span style="--shiki-light:#E2931D;--shiki-dark:#FFCB6B;">length-percentage</span><span style="--shiki-light:#39ADB5;--shiki-dark:#89DDFF;">&gt;</span><span style="--shiki-light:#90A4AE;--shiki-dark:#BABED8;"> where &lt;</span><span style="--shiki-light:#E2931D;--shiki-dark:#FFCB6B;">length-percentage</span><span style="--shiki-light:#39ADB5;--shiki-dark:#89DDFF;">&gt;</span><span style="--shiki-light:#90A4AE;--shiki-dark:#BABED8;"> = &lt;length</span><span style="--shiki-light:#39ADB5;--shiki-dark:#89DDFF;">&gt;</span></span>
<span class="line"><span style="--shiki-light:#39ADB5;--shiki-dark:#89DDFF;">  |</span><span style="--shiki-light:#90A4AE;--shiki-dark:#BABED8;"> &lt;percentage</span><span style="--shiki-light:#39ADB5;--shiki-dark:#89DDFF;">&gt;</span><span style="--shiki-light:#90A4AE;--shiki-dark:#BABED8;">;</span></span></code></pre></div><h2 id="值" tabindex="-1">值 <a class="header-anchor" href="#值" aria-label="Permalink to &quot;值&quot;">​</a></h2><ul><li>normal 浏览器使用的默认行距。对于多列布局，该值对应于 1em ，对于所有其他类型，该值对应于 0。这是默认值。</li><li>length / percentage 使用有效长度值或百分比值指定行之间的间距。该值必须为正。</li></ul>`,4))])}}});export{o as __pageData,E as default};
