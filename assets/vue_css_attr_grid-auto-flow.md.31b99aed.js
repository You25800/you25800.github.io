...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"  "),s("span",{style:{color:"#89DDFF"}},"}")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#89DDFF"}},"}")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#89DDFF"}},"</"),s("span",{style:{color:"#F07178"}},"style"),s("span",{style:{color:"#89DDFF"}},">")])])])],-1),x=C('<h2 id="语法" tabindex="-1">语法 <a class="header-anchor" href="#语法" aria-label="Permalink to &quot;语法&quot;">​</a></h2><div class="language-css"><button title="Copy Code" class="copy"></button><span class="lang">css</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#FFCB6B;">grid-auto-flow</span><span style="color:#A6ACCD;">: </span><span style="color:#89DDFF;">[</span><span style="color:#A6ACCD;"> </span><span style="color:#C792EA;">row</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">|</span><span style="color:#A6ACCD;"> </span><span style="color:#C792EA;">column</span><span style="color:#89DDFF;">]</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">|</span><span style="color:#A6ACCD;">| dense;</span></span></code></pre></div><h2 id="值" tabindex="-1">值 <a class="header-anchor" href="#值" aria-label="Permalink to &quot;值&quot;">​</a></h2><ul><li>row 一个关键字，指示自动放置算法通过依次填充每行并根据需要添加新行来放置元素。这是默认值。</li><li>column 一个关键字，指示自动放置算法通过依次填充每一列来放置元素，并根据需要添加新列。</li><li>dense 一个关键字，指示自动放置算法使用“密集”元素放置算法，如果布局中进一步出现适当大小的元素，该算法将尝试填充网格中以前形成的空隙。这可能导致元素的外观不符合指示的顺序，同时填补大元素留下的孔。如果省略此密集关键字，则使用“稀疏”算法，该算法将元素放置在网格中而不后退以填充空白。这可确保所有自动放置的元素都“按顺序”显示，即使这会留下可以用后面的元素填充的空白。</li></ul>',4),T=JSON.parse('{"title":"grid-auto-flow","description":"","frontmatter":{"layout":"doc"},"headers":[],"relativePath":"vue/css/attr/grid-auto-flow.md","filePath":"vue/css/attr/grid-auto-flow.md","lastUpdated":1690962385000}'),k={name:"vue/css/attr/grid-auto-flow.md"},P=Object.assign(k,{setup(n){return(e,a)=>{const o=g("demo");return F(),y("div",null,[B,p(o,{customClass:"",sourceCode:`<template>
  <div class="base">
