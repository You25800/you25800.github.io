import{_ as r,c as t,o as h,j as s,B as D,b3 as d,G as e,w as l,a as i}from"./chunks/framework.CatkIGlB.js";const g={},o={class:"base"};function A(k,n){return h(),t("div",o,[...n[0]||(n[0]=[s("p",null," Example of the :out-of-range pseudo class, try entering a number not between 1 and 10. ",-1),s("p",null,[s("input",{type:"number",min:"1",max:"10",value:"1",id:"inrange"}),s("label",{for:"inrange"})],-1)])])}const y=r(g,[["render",A],["__scopeId","data-v-fe4a398e"]]),c=JSON.parse('{"title":":out-of-range","description":"","frontmatter":{"layout":"doc"},"headers":[],"relativePath":"vue/css/pseudo-classes/out-of-range.md","filePath":"vue/css/pseudo-classes/out-of-range.md","lastUpdated":1691635753000}'),F={name:"vue/css/pseudo-classes/out-of-range.md"},E=Object.assign(F,{setup(k){return(n,a)=>{const p=D("demo");return h(),t("div",null,[a[1]||(a[1]=d(`<h1 id="out-of-range" tabindex="-1">:out-of-range <a class="header-anchor" href="#out-of-range" aria-label="Permalink to &quot;:out-of-range&quot;">​</a></h1><h2 id="描述" tabindex="-1">描述 <a class="header-anchor" href="#描述" aria-label="Permalink to &quot;描述&quot;">​</a></h2><p>:out-of-range 伪类适用于用户输入的值超出指定范围的表单字段。即使受到 min 和 max 属性的限制，伪类也仅适用于用户可以输入值的那些字段。</p><h2 id="语法" tabindex="-1">语法 <a class="header-anchor" href="#语法" aria-label="Permalink to &quot;语法&quot;">​</a></h2><div class="language-css vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">css</span><pre class="shiki shiki-themes material-theme-lighter material-theme-palenight vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#E2931D;--shiki-dark:#FFCB6B;">element</span><span style="--shiki-light:#39ADB5;--shiki-dark:#89DDFF;">:</span><span style="--shiki-light:#9C3EDA;--shiki-dark:#C792EA;">out-of-range</span><span style="--shiki-light:#39ADB5;--shiki-dark:#89DDFF;"> {</span></span>
...
<span class="line"><span style="--shiki-light:#39ADB5;--shiki-dark:#89DDFF;">}</span></span></code></pre></div><h2 id="效果展示" tabindex="-1">效果展示 <a class="header-anchor" href="#效果展示" aria-label="Permalink to &quot;效果展示&quot;">​</a></h2>`,6)),e(p,{customClass:"",sourceCode:`<template>
  <div class="base">
    <p>
      Example of the :out-of-range pseudo class, try entering a number not
      between 1 and 10.
