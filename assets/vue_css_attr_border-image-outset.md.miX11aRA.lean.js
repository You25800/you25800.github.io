import{_ as p,c as n,o as r,j as s,B as o,b3 as t,G as l,w as h,a as i}from"./chunks/framework.CatkIGlB.js";const g={},D={class:"base"};function A(k,e){return r(),n("div",D,[...e[0]||(e[0]=[s("div",null,"Example of the border-image-outset property",-1)])])}const c=p(g,[["render",A],["__scopeId","data-v-83415e7a"]]),y=JSON.parse('{"title":"border-image-outset","description":"","frontmatter":{"layout":"doc"},"headers":[],"relativePath":"vue/css/attr/border-image-outset.md","filePath":"vue/css/attr/border-image-outset.md","lastUpdated":1690772333000}'),m={name:"vue/css/attr/border-image-outset.md"},E=Object.assign(m,{setup(k){return(e,a)=>{const d=o("demo");return r(),n("div",null,[a[1]||(a[1]=t("",4)),l(d,{customClass:"",sourceCode:`<template>
  <div class="base"><div>Example of the border-image-outset property</div></div>
</template>
...
`),s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#90A4AE","--shiki-dark":"#BABED8"}},"    border-image-outset: 20px 2;")]),i(`
...
`),s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#90A4AE","--shiki-dark":"#BABED8"}},"}")]),i(`
`),s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#39ADB5","--shiki-dark":"#89DDFF"}},"</"),s("span",{style:{"--shiki-light":"#E53935","--shiki-dark":"#F07178"}},"style"),s("span",{style:{"--shiki-light":"#39ADB5","--shiki-dark":"#89DDFF"}},">")])])])],-1)])]),default:h(()=>[l(c)]),_:1}),a[2]||(a[2]=t("",4))])}}});export{y as __pageData,E as default};
