import{_ as D,o as n,c as t,R as e,D as F,G as o,B as a,z as s,a as l}from"./chunks/framework.318fa179.js";const y={},d={class:"base"},C=e("<table data-v-516de22c><tr data-v-516de22c><td data-v-516de22c>No</td><td data-v-516de22c>Competition</td><td data-v-516de22c>John</td><td data-v-516de22c>Adam</td><td data-v-516de22c>Robert</td><td data-v-516de22c>Paul</td></tr><tr data-v-516de22c><td data-v-516de22c>1</td><td data-v-516de22c>Swimming</td><td data-v-516de22c>1:30</td><td data-v-516de22c>2:05</td><td data-v-516de22c>1:15</td><td data-v-516de22c>1:41</td></tr><tr data-v-516de22c><td data-v-516de22c>2</td><td data-v-516de22c>Running</td><td data-v-516de22c>15:30</td><td data-v-516de22c>14:10</td><td data-v-516de22c>15:45</td><td data-v-516de22c>16:00</td></tr><tr data-v-516de22c><td data-v-516de22c>3</td><td data-v-516de22c>Shooting</td><td data-v-516de22c>70%</td><td data-v-516de22c>55%</td><td data-v-516de22c>90%</td><td data-v-516de22c>88%</td></tr></table>",1),A=[C];function i(c,p){return n(),t("div",d,A)}const h=D(y,[["render",i],["__scopeId","data-v-516de22c"]]),_=e(`<h1 id="nth-child" tabindex="-1">:nth-child <a class="header-anchor" href="#nth-child" aria-label="Permalink to &quot;:nth-child&quot;">​</a></h1><h2 id="描述" tabindex="-1">描述 <a class="header-anchor" href="#描述" aria-label="Permalink to &quot;描述&quot;">​</a></h2><p>:nth-child 伪类用于根据元素树中的编号向元素添加样式。</p><h2 id="语法" tabindex="-1">语法 <a class="header-anchor" href="#语法" aria-label="Permalink to &quot;语法&quot;">​</a></h2><div class="language-css"><button title="Copy Code" class="copy"></button><span class="lang">css</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#FFCB6B;">element</span><span style="color:#A6ACCD;">:</span><span style="color:#FFCB6B;">nth-child</span><span style="color:#A6ACCD;"> (odd </span><span style="color:#89DDFF;">|</span><span style="color:#A6ACCD;"> even </span><span style="color:#89DDFF;">|</span><span style="color:#A6ACCD;"> &lt;number</span><span style="color:#89DDFF;">&gt;</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">|</span><span style="color:#A6ACCD;"> &lt;expression</span><span style="color:#89DDFF;">&gt;</span><span style="color:#A6ACCD;">) </span><span style="color:#89DDFF;">{</span></span>
<span class="line"><span style="color:#A6ACCD;">  ...</span><span style="color:#89DDFF;">;</span></span>
<span class="line"><span style="color:#89DDFF;">}</span></span></code></pre></div><h2 id="值" tabindex="-1">值 <a class="header-anchor" href="#值" aria-label="Permalink to &quot;值&quot;">​</a></h2><ul><li>odd 所有奇数项目编号。</li><li>even 所有项目编号均为偶数。</li><li><code>&lt;number&gt;</code> 子项相对于其父项的序列号。编号从 1 开始，这将是列表中的第一项。</li><li><code>&lt;expression&gt;</code> 它以 an ± b 的形式给出，其中 a 和 b 是整数，n 是一个计数器，自动取值 0、1、2 ... 如果 a 为零，则不写入并且记录减少到 b。如果 b 为零，则也未指定，并且表达式以 an 形式编写。 a 和 b 可以是负数，在这种情况下，加号变为减号，例如：5n-1。 通过使用 a 和 b 的负值，某些结果也可能变为负数或等于零。但是，由于元素编号从 1 开始，元素仅受正值影响。</li></ul><h2 id="效果展示" tabindex="-1">效果展示 <a class="header-anchor" href="#效果展示" aria-label="Permalink to &quot;效果展示&quot;">​</a></h2>`,8),v=s("div",{class:"language-vue vp-adaptive-theme"},[s("span",{class:"lang"},"vue"),s("pre",{"v-pre":"",class:"shiki material-theme-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#89DDFF"}},"<"),s("span",{style:{color:"#F07178"}},"template"),s("span",{style:{color:"#89DDFF"}},">")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"  "),s("span",{style:{color:"#FFCB6B"}},"tr"),s("span",{style:{color:"#89DDFF"}},":"),s("span",{style:{color:"#C792EA"}},"nth-child"),s("span",{style:{color:"#89DDFF"}},"("),s("span",{style:{color:"#F78C6C"}},"2"),s("span",{style:{color:"#A6ACCD"}},"n"),s("span",{style:{color:"#89DDFF"}},")"),s("span",{style:{color:"#A6ACCD"}}," "),s("span",{style:{color:"#89DDFF"}},"{")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"    "),s("span",{style:{color:"#B2CCD6"}},"background"),s("span",{style:{color:"#89DDFF"}},":"),s("span",{style:{color:"#A6ACCD"}}," "),s("span",{style:{color:"#89DDFF"}},"#"),s("span",{style:{color:"#A6ACCD"}},"a3ffa8"),s("span",{style:{color:"#89DDFF"}},";")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"  "),s("span",{style:{color:"#89DDFF"}},"}")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"  "),s("span",{style:{color:"#FFCB6B"}},"tr"),s("span",{style:{color:"#89DDFF"}},":"),s("span",{style:{color:"#C792EA"}},"nth-child"),s("span",{style:{color:"#89DDFF"}},"("),s("span",{style:{color:"#F78C6C"}},"1"),s("span",{style:{color:"#89DDFF"}},")"),s("span",{style:{color:"#A6ACCD"}}," "),s("span",{style:{color:"#89DDFF"}},"{")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#A6ACCD"}},"    "),s("span",{style:{color:"#B2CCD6"}},"background"),s("span",{style:{color:"#89DDFF"}},":"),s("span",{style:{color:"#A6ACCD"}}," "),s("span",{style:{color:"#89DDFF"}},"#"),s("span",{style:{color:"#A6ACCD"}},"001aad"),s("span",{style:{color:"#89DDFF"}},";")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#89DDFF"}},"</"),s("span",{style:{color:"#F07178"}},"style"),s("span",{style:{color:"#89DDFF"}},">")])])])],-1),g=JSON.parse('{"title":":nth-child","description":"","frontmatter":{"layout":"doc"},"headers":[],"relativePath":"vue/css/pseudo-classes/nth-child.md","filePath":"vue/css/pseudo-classes/nth-child.md","lastUpdated":1691635753000}'),u={name:"vue/css/pseudo-classes/nth-child.md"},f=Object.assign(u,{setup(c){return(p,m)=>{const r=F("demo");return n(),t("div",null,[_,o(r,{customClass:"",sourceCode:`<template>
  <div class="base">
    <table>
      <tr>
        <td>No</td>
...
`},{highlight:a(()=>[v]),default:a(()=>[o(h)]),_:1})])}}});export{g as __pageData,f as default};
