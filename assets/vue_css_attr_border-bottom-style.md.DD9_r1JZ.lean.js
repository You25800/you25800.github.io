import{_ as p,c as n,o as k,j as s,B as o,b3 as e,G as l,w as h,a as i}from"./chunks/framework.CatkIGlB.js";const D={},A={class:"base"};function g(r,t){return k(),n("div",A,[...t[0]||(t[0]=[s("div",{class:"border"}," This is an example of the border-bottom-style property using a red solid border 3px in width. ",-1)])])}const y=p(D,[["render",g],["__scopeId","data-v-08fbad73"]]),F=JSON.parse('{"title":"border-bottom-style","description":"","frontmatter":{"layout":"doc"},"headers":[],"relativePath":"vue/css/attr/border-bottom-style.md","filePath":"vue/css/attr/border-bottom-style.md","lastUpdated":1690536596000}'),B={name:"vue/css/attr/border-bottom-style.md"},b=Object.assign(B,{setup(r){return(t,a)=>{const d=o("demo");return k(),n("div",null,[a[1]||(a[1]=e("",4)),l(d,{customClass:"",sourceCode:`<template>
  <div class="base">
    <div class="border">
      This is an example of the border-bottom-style property using a red solid
      border 3px in width.
    </div>
  </div>
</template>
...
`),s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#90A4AE","--shiki-dark":"#BABED8"}},"      This is an example of the border-bottom-style property using a red solid")]),i(`
...
`),s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#90A4AE","--shiki-dark":"#BABED8"}},"    border-bottom-style: solid;")]),i(`
`),s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#90A4AE","--shiki-dark":"#BABED8"}},"    border-bottom-width: 3px;")]),i(`
`),s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#90A4AE","--shiki-dark":"#BABED8"}},"    border-bottom-color: red;")]),i(`
...
`),s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#90A4AE","--shiki-dark":"#BABED8"}},"}")]),i(`
`),s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#39ADB5","--shiki-dark":"#89DDFF"}},"</"),s("span",{style:{"--shiki-light":"#E53935","--shiki-dark":"#F07178"}},"style"),s("span",{style:{"--shiki-light":"#39ADB5","--shiki-dark":"#89DDFF"}},">")])])])],-1)])]),default:h(()=>[l(y)]),_:1}),a[2]||(a[2]=e("",4))])}}});export{F as __pageData,b as default};
