import{_ as d,c as h,o as n,j as s,B as p,b3 as D,G as l,w as e,a as i}from"./chunks/framework.CatkIGlB.js";const o={},g={class:"base"};function A(k,t){return n(),h("div",g,[...t[0]||(t[0]=[s("div",{class:"normal rotated"},"Rotated",-1),s("div",{class:"normal"},"Not rotated",-1)])])}const c=d(o,[["render",A],["__scopeId","data-v-238718be"]]),B=JSON.parse('{"title":"rotate()","description":"","frontmatter":{"layout":"doc"},"headers":[],"relativePath":"vue/css/function/rotate.md","filePath":"vue/css/function/rotate.md","lastUpdated":1691713347000}'),y={name:"vue/css/function/rotate.md"},E=Object.assign(y,{setup(k){return(t,a)=>{const r=p("demo");return n(),h("div",null,[a[1]||(a[1]=D('<h1 id="rotate" tabindex="-1">rotate() <a class="header-anchor" href="#rotate" aria-label="Permalink to &quot;rotate()&quot;">​</a></h1><h2 id="描述" tabindex="-1">描述 <a class="header-anchor" href="#描述" aria-label="Permalink to &quot;描述&quot;">​</a></h2><p>rotate() CSS 函数将二维空间中的元素围绕旋转点旋转给定角度。默认枢轴点位于元素的中心，可以使用 Transform-origin 属性进行更改。</p><h2 id="语法" tabindex="-1">语法 <a class="header-anchor" href="#语法" aria-label="Permalink to &quot;语法&quot;">​</a></h2><div class="language-css vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">css</span><pre class="shiki shiki-themes material-theme-lighter material-theme-palenight vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#90A4AE;--shiki-dark:#BABED8;">transform: rotate(&lt;angle</span><span style="--shiki-light:#39ADB5;--shiki-dark:#89DDFF;">&gt;</span><span style="--shiki-light:#90A4AE;--shiki-dark:#BABED8;">);</span></span></code></pre></div><h2 id="值" tabindex="-1">值 <a class="header-anchor" href="#值" aria-label="Permalink to &quot;值&quot;">​</a></h2><ul><li><code>&lt;angle&gt;</code> 正值使元素顺时针旋转，负值使元素逆时针旋转。</li></ul><h2 id="效果展示" tabindex="-1">效果展示 <a class="header-anchor" href="#效果展示" aria-label="Permalink to &quot;效果展示&quot;">​</a></h2>',8)),l(r,{customClass:"",sourceCode:`<template>
  <div class="base">
...
`),s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#90A4AE","--shiki-dark":"#BABED8"}},"    transform: rotate(45deg);")]),i(`
`),s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#90A4AE","--shiki-dark":"#BABED8"}},"  }")]),i(`
`),s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#90A4AE","--shiki-dark":"#BABED8"}},"}")]),i(`
