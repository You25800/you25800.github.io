import{_ as p,c as e,o as k,j as s,B as D,b3 as n,G as h,w as t,a as i}from"./chunks/framework.CatkIGlB.js";const c={},o={class:"base"};function A(r,a){return k(),e("div",o,[...a[0]||(a[0]=[s("div",{class:"scroller"},[s("div",null,"1"),s("div",null,"2"),s("div",null,"3"),s("div",null,"4")],-1)])])}const g=p(c,[["render",A],["__scopeId","data-v-dbe77dab"]]),F=JSON.parse('{"title":"scroll-margin-block-end","description":"","frontmatter":{"layout":"doc"},"headers":[],"relativePath":"vue/css/attr/scroll-margin-block-end.md","filePath":"vue/css/attr/scroll-margin-block-end.md","lastUpdated":1691547431000}'),y={name:"vue/css/attr/scroll-margin-block-end.md"},E=Object.assign(y,{setup(r){return(a,l)=>{const d=D("demo");return k(),e("div",null,[l[1]||(l[1]=n('<h1 id="scroll-margin-block-end" tabindex="-1">scroll-margin-block-end <a class="header-anchor" href="#scroll-margin-block-end" aria-label="Permalink to &quot;scroll-margin-block-end&quot;">​</a></h1><h2 id="描述" tabindex="-1">描述 <a class="header-anchor" href="#描述" aria-label="Permalink to &quot;描述&quot;">​</a></h2><p>scroll-margin-block-end 属性定义块尺寸末尾的滚动捕捉区域的边距，用于将此框捕捉到捕捉端口。滚动捕捉区域是通过获取变换后的边框框、找到其矩形边框（在滚动容器的坐标空间中轴对齐）、然后添加指定的起始点来确定的。</p><h2 id="效果展示" tabindex="-1">效果展示 <a class="header-anchor" href="#效果展示" aria-label="Permalink to &quot;效果展示&quot;">​</a></h2>',4)),h(d,{customClass:"",sourceCode:`<template>
  <div class="base">
    <div class="scroller">
      <div>1</div>
      <div>2</div>
...
`),s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#90A4AE","--shiki-dark":"#BABED8"}},"    scroll-margin-block-end: 20px;")]),i(`
`),s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#90A4AE","--shiki-dark":"#BABED8"}},"  }")]),i(`
`),s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#90A4AE","--shiki-dark":"#BABED8"}},"}")]),i(`
`),s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#39ADB5","--shiki-dark":"#89DDFF"}},"</"),s("span",{style:{"--shiki-light":"#E53935","--shiki-dark":"#F07178"}},"style"),s("span",{style:{"--shiki-light":"#39ADB5","--shiki-dark":"#89DDFF"}},">")])])])],-1)])]),default:t(()=>[h(g)]),_:1}),l[2]||(l[2]=n(`<h2 id="语法" tabindex="-1">语法 <a class="header-anchor" href="#语法" aria-label="Permalink to &quot;语法&quot;">​</a></h2><div class="language-css vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">css</span><pre class="shiki shiki-themes material-theme-lighter material-theme-palenight vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#90A4AE;--shiki-light-font-style:italic;--shiki-dark:#676E95;--shiki-dark-font-style:italic;">/* &lt;length&gt; values */</span></span>
<span class="line"><span style="--shiki-light:#E2931D;--shiki-dark:#FFCB6B;">scroll-margin-block-end</span><span style="--shiki-light:#90A4AE;--shiki-dark:#BABED8;">: 10px;</span></span>
<span class="line"><span style="--shiki-light:#E2931D;--shiki-dark:#FFCB6B;">scroll-margin-block-end</span><span style="--shiki-light:#90A4AE;--shiki-dark:#BABED8;">: 1em;</span></span></code></pre></div><h2 id="值" tabindex="-1">值 <a class="header-anchor" href="#值" aria-label="Permalink to &quot;值&quot;">​</a></h2><ul><li><code>&lt;length&gt;</code> 从滚动容器的相应边缘开始。</li></ul>`,4))])}}});export{F as __pageData,E as default};
